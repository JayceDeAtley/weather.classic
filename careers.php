...
<title>Careers in Weather - NOAA's National Weather Service</title>
<meta name="DC.title" content="Careers in Weather - NOAA's National Weather Service" />
...
<meta name="DC.date.reviewed" scheme="ISO8601" content="2008-03-06" />
	...
	<!-- Start Content area... 525px wide -->
      ...
      <table width="525" border="0" cellpadding="0" cellspacing="2">
        <tr>
          ...
          <td valign="top"><a name="contents" id="contents"></a><a href="/">Home</a> > Careers<br />
            <br /></td>
        </tr>
        <tr>
          <td valign="top"><!--  *****************  START CONTENT SECTION  *************   -->
            <h3>Careers </h3></td>
        </tr>
        <tr>
          <td valign="top"><p>This page contains links to websites that are related to a career in weather and atmospheric sciences</p>
            <ul>
              <li><a
href="/cgi-bin/nwsexit.pl?url=http://www.ametsoc.org/ams/atmoscareers/">How to Become a Meteorologist</a></li>
              <li><a href="http://www.weather.gov/com/nwsfocus/fs20060508_job.htm">Job Application Primer Offers Specific Advice on Selection Process</a></li>
              <li><a href="http://jobsearch.usajobs.opm.gov/a9noaa.asp">Job Openings</a></li>
              <li><a href="http://www.rdc.noaa.gov/diversity.html">NOAA Diversity</a></li>
              <li><a href="http://www.nws.noaa.gov/diversity/">NWS Diversity</a></li>
              <li><a href="http://www.weather.gov/eeo/StudentResearchOpportunities.php">NWS Student Employment Programs</a></li>
              <li><a href="http://www.opm.gov/qualifications/SEC-IV/B/GS1300/1340.htm">Qualifications</a></li>
              <li><a href="http://www.wfm.noaa.gov/">Workforce Management Office (WFMO)</a></li>
            </ul>
...
<!-- end footer inc -->      <!-- end footer -->
      ...
      <!-- start modified date -->
      <!-- #BeginDate format:Sw1a -->6 March, 2008 5:29 AM<!-- #EndDate -->
      <!-- end modified date -->
      </span> <!-- #EndEditable --> </td>
  </tr>
</table>
