...
<title>Climate Data and Products Access Page - NOAA's National Weather Service</title>
<meta name="DC.title" content="Climate Data and Products Access Page - NOAA's National Weather Service" />
...
<!-- ========== end leftmenu inc ========== -->
    ...
    <td width="525" valign="top">
      ...
      <table width="525" border="0" cellpadding="0" cellspacing="2">
        <tr>
          <td rowspan="3">&nbsp;</td>
          <td><a name="contents" id="contents"></a><a href="/">Home</a> > Climate<br />
          <br /></td>
        </tr>
        <tr>
          <td><!--  *****************  START CONTENT SECTION  *************   -->            <h3>NOAA Climate Data </h3></td>
        </tr>
        <tr>
          <td><p><strong>NOAA locations that provide climatic data &amp; historical data records</strong>
            </p>
            <p><strong> [ </strong><a
href="/cgi-bin/nwsexit.pl?url=http://www.ncdc.noaa.gov/&amp;blurb=Climate+National+Climatic+Data+Center"> National Climatic Data Center</a> <b> | </b> <a href="http://www.cpc.ncep.noaa.gov/">NCEP Climate Prediction Center</a> <strong> ] </strong> </p>
            <p><strong> [ </strong><a
href="/cgi-bin/nwsexit.pl?url=http://www.pmel.noaa.gov/tao/&amp;blurb=Tropical+Atmosphere+Ocean+Project"> PMEL TAO Climate Project</a> <b> | </b> <a
href="/cgi-bin/nwsexit.pl?url=http://www.cdc.noaa.gov/&amp;blurb=Climate+Diagnostics+Center"> Climate Diagnostics Center</a> <strong> ]</strong></p>
            <p><strong>[ </strong><a href="/oh/hdsc">Rainfall Frequency Atlases</a> <strong> ]</strong> </p>
            <p><strong>Other Climate Centers</strong></p>
            <p><strong> [ </strong> <a
href="/cgi-bin/nwsexit.pl?url=http://climate.gi.alaska.edu&amp;blurb=Alaska+Regional+Climate+Center"> Alaska Regional Climate Center</a> <b> | </b> <a
href="/cgi-bin/nwsexit.pl?url=http://met-www.cit.cornell.edu/other_rcc.html&amp;blurb=Jointly+Sponsored+Regional+Climate+Centers"> Jointly Sponsored Regional Climatic Centers</a> <strong> ] </strong></p>
            <p><font size="-1">Note: "Regional Climate Centers" are joint programs among university, state, and/or Federal Goverment agencies.</font></p>
            <strong> [ </strong> <a
href="/cgi-bin/nwsexit.pl?url=http://www.giss.nasa.gov/data/&amp;blurb=NASA+Goddard+Institute+for+Space+Studies"> NASA Goddard Institute for Space Studies</a> <strong> ] </strong> <a href="/climatex.html"> U.S. Monthly Mean Temperature &amp; Precipitation Tables </a>
            <!--  *****************  END CONTENT SECTION  *************   -->
          </td>
        </tr>
      </table>
...
&nbsp;&nbsp;&nbsp;&nbsp; <span class="gray">Page last Modified:</span> <!-- #BeginEditable "DateLastMod" --> <span class="gray">
      <!-- start modified date -->
      <!-- #BeginDate format:Sw1a -->8 September, 2005 9:23 AM<!-- #EndDate -->
      <!-- end modified date -->
      </span> <!-- #EndEditable --> </td>
  </tr>
</table>
