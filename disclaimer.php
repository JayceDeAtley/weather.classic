...
<title>Forecast Products Disclaimer -NOAA's National Weather Service</title>
<meta name="DC.title" content="Forecast Products Disclaimer -NOAA's National Weather Service" />
...
<!-- ========== end leftmenu inc ========== -->
    ...
    <td width="525" valign="top">
      ...
      <table width="525" border="0" cellpadding="0" cellspacing="2">
        <tr>
          <td rowspan="3">&nbsp;</td>
          <td><a name="contents" id="contents"></a><a href="/">Home</a> > Disclaimer <br />
            <br />
          </td>
        </tr>
        <tr>
          <td><!--  *****************  START CONTENT SECTION  *************   -->
            <h3>About the information on this U.S. Government server </h3></td>
        </tr>
        <tr>
          <td><br />
            <p><img src="/images/bltpurple.gif" alt=" " width="10" height="10" border="0" />&nbsp;This operational server maintains a current database of meteorological and hydrological data, historical data, and written information generated by the NWS or received from other official sources. In addition, this server accesses in realtime a selection of current <i> official</i> weather observations, forecasts, and warnings from U.S. government sources for use by the national and international community. In an effort to enhance the science, experimental products may be accessible on this server and care must be taken when using such products as they are intended for research use.</p>
            <p><img src="/images/bltpurple.gif" alt=" " width="10" height="10" border="0" />&nbsp;This server is available<b> 24 hours a day, seven days a week</b> . Timely delivery of data and products from this server through the Internet is not guaranteed. Official NWS dissemination systems which can provide timely delivery of data and products are listed below. </p>
            <ul>
              <li><a href="/nwr/">NOAA Weather Radio</a>, </li>
              <li><a href="/oso/oso1/oso15/newnwws.htm"> NOAA Weather Wire</a>, </li>
              <li><a href="http://iwin.nws.noaa.gov/emwin/index.htm">EMWIN®</a>, </li>
              <li><a href="/oso/fospage.shtml">Family of Services</a> (FOS), </li>
              <li><a href="/noaaport/html/noaaport.shtml">NOAAPORT</a>, </li>
              <li>and your local <a href="/organization.php">National Weather Service</a>. </li>
            </ul>
            <p></p>
            <b>Use of Data and Products</b>
            <p><img src="/images/bltpurple.gif" alt=" " width="10" height="10" border="0" />&nbsp;The information on government servers are in the<b> public domain</b>, unless specifically annotated otherwise, and may be used freely by the public. Before using information obtained from this server special attention should be given to the <b>date &amp; time</b> of the data and products being displayed. This information shall not be modified in content and then presented as official government material.</p>
            <p><img src="/images/bltpurple.gif" alt=" " width="10" height="10" border="0" />&nbsp;The user assumes the entire risk related to its use of this data. NWS is providing this data "as is," and NWS disclaims any and all warranties, whether express or implied, including (without limitation) any implied warranties of merchantability or fitness for a particular purpose. In no event will NWS be liable to you or to any third party for any direct, indirect, incidental, consequential, special or exemplary damages or lost profit resulting from any use or misuse of this data.</p>
            <p><img src="/images/bltpurple.gif" alt=" " width="10" height="10" border="0" />&nbsp;<b><i>As required by 17 U.S.C. 403, third parties producing copyrighted works consisting predominantly of the material appearing in NWS Web pages must provide notice with such work(s) identifying the NWS material incorporated and stating that such material is not subject to copyright protection.</i></b></p>
            <b>Hyperlinks</b>
            <p>Any reference from NWS Web server service to any non-government entity, product, service or information does not constitute an endorsement or recommendation by the National Oceanic Atmospheric Administration or any of its' field offices or employees. We are not responsible for the contents of any "off-site" web pages referenced from NWS servers.</p>
            <!--  *****************  END CONTENT SECTION  *************   -->
          </td>
        </tr>
      </table>
...
&nbsp;&nbsp;&nbsp;&nbsp; <span class="gray">Page last Modified:</span> <!-- #BeginEditable "DateLastMod" --> <span class="gray">
      <!-- start modified date -->
      <!-- #BeginDate format:Sw1a -->8 September, 2005 9:24 AM<!-- #EndDate -->
      <!-- end modified date -->
      </span> <!-- #EndEditable --> </td>
  </tr>
</table>
