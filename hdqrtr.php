...
<title>The Organization and Structure to Areas of NWS Headquarters - NOAA's National
Weather Service</title>
<meta name="DC.title" content="The Organization and Structure to Areas of NWS Headquarters - NOAA's National Weather Service" />
...
<meta name="DC.date.reviewed" scheme="ISO8601" content="2007-09-05" />
...
<!-- ========== end leftmenu inc ========== -->
    ...
    <td width="525" valign="top"><!-- Start Content area... 525px wide -->
      ...
      <table width="525" border="0" cellpadding="2" cellspacing="2">
        <tr>
          <td rowspan="3">&nbsp;</td>
          <td><a name="contents" id="contents"></a><a href="/">Home</a> &gt; Headquarters<br />
            <br />
          </td>
        </tr>
        <tr>
          <td class="pagetitle"><!--  *****************  START CONTENT SECTION  *************   -->
            NWS Headquarters Organization and Structure</td>
        </tr>
        <tr>
          <td><div align="center">| <a href="/ost">Office of Science &amp; Technology</a> | <a href="/oh">Office
                of Hydrologic Development</a> <br />
              | <a href="/oos/">Office of Operational Systems</a> | <a href="/om">Office
              of Climate, Water, &amp; Weather Services</a> | </div>
            <h4 align="center">Office of the Assistant Administrator for Weather
              Services</h4>
            <table width="100%" border="0" cellpadding="2" cellspacing="0">
              <tbody>
                <tr>
                  <td align="center" valign="top"><br />
                    <a href="http://www.weather.gov/com/presentations/hayes.htm">
                    <img src="/images/hayes_small.jpg" alt="Dr. John L. Hayes's Photo" width="173" height="167" border="0"  title="Dr. John L. Hayes's Photo"/>
                    </a>
                    <br />
                    <strong>Dr. John &quot;Jack&quot; L. Hayes<br />
					...
					<a href="http://www.nws.noaa.gov/com/presentations/hayes.htm">Biography</a></td>
                  <td width="50%" valign="top"><div align="center"><strong>MISSION</strong> </div>
                    <p><b>&quot;<i>NOAA's National Weather Service provides weather,
                          hydrologic, and climate forecasts and warnings for
                          the United States, its territories, adjacent waters
                          and ocean areas, for the protection of life and property
                          ...
                          agencies, the private sector, the public, and the global
                          community.</i>&quot;</b></p></td>
                </tr>
                <tr>
                  <td colspan="2" align="center" valign="top"><h4> Headquarters</h4>
                    <a href="/hdqreorg.php">National Weather Service Headquarters Structure</a>
                    <!-- | Organizational Charts--></td>
                </tr>
              </tbody>
            </table>
            <h4>Assistant Administrator's Staff Offices</h4>
            <ul>
              <li><a href="/eeo/">Office of Equal Opportunity and Diversity Management</a> [W/OEODM]
                - Advises senior management on matters concerning EEO &amp; Diversity
                Management </li>
              <li><a href="/ia/home.htm">International Activities Office</a> [W/IA]
                - Support to U.S. representative to WMO, administers foreign
                assistance and coordinates US aid </li>
              <li><a href="/sp/">Strategic Planning &amp; Policy</a> [W/SP] -
                Develops and implements an integrated approach to policy, strategy,
                and long-range planning </li>
              <li><a href="/com/">Communications Office</a> [W/COM] - Coordinates
                communications efforts for senior management, develops corporate
                image </li>
            </ul>
            <p><img src="images/bltpurple.gif" border="0" width="10" height="10"
 alt=" " hspace="5" /><a href="/cfo">Office of the Chief Financial Officer/Chief
                Administrative Officer</a> [W/CFO] - Obtains and manages NWS
                financial, human, and physical resources</p>
            <p><img src="images/bltpurple.gif" border="0" width="10" height="10"
 alt=" " hspace="5" /><a href="/cio/">Office of the Chief Information Officer</a> [W/CIO]
              - Develops Information Technology (IT) policies, standards, and
              guidelines</p>
            <hr />
            <h4 align="center">Headquarters Offices</h4>
            <p><img src="images/bltpurple.gif" border="0" width="10" height="10"
 alt=" " hspace="5" /><a href="/om/">Office of Climate, Water, and Weather Services</a> [W/OS]
              - Directs, plans, and establishes policies and procedures for weather,
              water, and climate warning and forecast services</p>
            <p><img src="images/bltpurple.gif" border="0" width="10" height="10"
 alt=" " hspace="5" /><a href="/ost">Office of Science &amp; Technology</a> [W/OST]
              - Overall responsibility for science and technology plans, programs,
              and development activities</p>
            <p><img src="images/bltpurple.gif" border="0" width="10" height="10"
 alt=" " hspace="5" /><a href="/oh/">Office of Hydrologic Development</a> [W/OHD]
              - Directs hydrologic development, including funding resources,
              administration, and program direction</p>
            <p><img src="images/bltpurple.gif" border="0" width="10" height="10"
 alt=" " hspace="5" /><a href="/oos/">Office of Operational Systems</a> [W/OPS]
              - Manages systems, engineering software management, facilities,
              communications, and logistical services</p>
            <!--  *****************  END CONTENT SECTION  *************   -->
          </td>
        </tr>
      </table>
...
<!-- end footer inc -->      <!-- end footer -->
      ...
      <!-- start modified date -->
      <!-- #BeginDate format:Sw1a -->11 September, 2007 7:52 AM<!-- #EndDate -->
      <!-- end modified date -->
      </span> <!-- #EndEditable --> </td>
  </tr>
</table>
