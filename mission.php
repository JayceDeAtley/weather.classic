...
<title>Mission Statement - NOAA's National Weather Service</title>
<meta name="DC.title" content="Mission Statement - NOAA's National Weather Service" />
...
<!-- ========== end leftmenu inc ========== -->
    ...
    <td width="525" valign="top">
      ...
      <table width="525" border="0" cellpadding="0" cellspacing="2">
        <tr>
          <td rowspan="3">&nbsp;</td>
          <td><a name="contents" id="contents"></a><a href="/">Home</a> > Mission <br />
            <br />
          </td>
        </tr>
        <tr>
          ...
          <h3>National Weather Service Mission Statement</h3></td>
        </tr>
        <tr>
          <td><br />
            <p><b>" <i> The National Weather Service (NWS) provides weather, hydrologic, and climate forecasts and warnings for the United States, its territories, adjacent waters and ocean areas, for the protection of life and property and the enhancement of the national economy. NWS data and products form a national information database and infrastructure which can be used by other governmental agencies, the private sector, the public, and the global community.</i> " </b></p>
            <div align="center">
              <h4>And Our<br />
                <a href="/sp/">STRATEGIC PLAN</a></h4></div>
                <!--  *****************  END CONTENT SECTION  *************   -->
...
&nbsp;&nbsp;&nbsp;&nbsp; <span class="gray">Page last Modified:</span> <!-- #BeginEditable "DateLastMod" --> <span class="gray">
      <!-- start modified date -->
      <!-- #BeginDate format:Sw1a -->8 September, 2005 9:35 AM<!-- #EndDate -->
      <!-- end modified date -->
      </span> <!-- #EndEditable --> </td>
  </tr>
</table>
