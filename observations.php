...
<title>Observations - NOAA's National Weather Service</title>
<meta name="DC.title" content="Observations - NOAA's National Weather Service" />
...
<meta name="DC.date.reviewed" scheme="ISO8601" content="2007-05-03" />
...
<!-- ========== end leftmenu inc ========== -->
    ...
    <td width="525" valign="top"><!-- Start Content area... 525px wide -->
      ...
      <table width="525" border="0" cellpadding="0" cellspacing="2">
        <tr>
          <td rowspan="3">&nbsp;</td>
          <td class="breadcrumb"><a name="contents" id="contents"></a><a href="/">Home</a> &gt; Observations <br />
            <br />
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td> This page contains links to National Oceanic Atmospheric Administration
            web sites that contain information about observations that NWS makes
            or disseminates.
            <ul>
              <li> <a href="/radar_tab.php">Radar</a></li>
              <li><a href="http://www.goes.noaa.gov/">Satellite</a></li>
              <li><a href="/om/osd/portal.shtml">Surface Weather</a></li>
              <li><a href="/data/current_obs/">Surface Weather in XML/RSS formats</a></li>
              <li><a href="http://www.nws.noaa.gov/om/coop/index.htm">Cooperative
                  Observation Network</a></li>
              <li><a href="/om/osd/portal.shtml">Upper Air</a></li>
              <li><a href="http://www.ndbc.noaa.gov/rmd.shtml">Buoy Reports</a></li>
              <li><a href="http://www.nws.noaa.gov/ahps/">River Levels</a></li>
              <li><a href="http://www.cpc.ncep.noaa.gov/products/MD_index.html">Climate
                  Monitoring</a></li>
              <li><a href="http://www.sec.noaa.gov/">Space Weather</a></li>
            </ul>
            <!--  *****************  END CONTENT SECTION  *************   -->
          </td>
        </tr>
...
<!-- end footer inc -->      <!-- end footer -->
      ...
      <!-- start modified date -->
      <!-- #BeginDate format:Sw1a -->3 May, 2007 7:10 AM<!-- #EndDate -->
      <!-- end modified date -->
      </span> <!-- #EndEditable --> </td>
  </tr>
</table>
