...
<title>Page Not Found - NOAA's National Weather Service</title>
<meta name="DC.title" content="Page Not Found - NOAA's National Weather Service" />
...
<!-- ========== end leftmenu inc ========== -->
    ...
    <td width="525" valign="top">
      ...
      <table width="525" border="0" cellpadding="0" cellspacing="2">
        <tr>
          <td rowspan="3">&nbsp;</td>
          <td><a name="contents" id="contents"></a><a href="/">Home</a> > Page Not Found <br />
            <br />
          </td>
        </tr>
        <tr>
          <td><!--  *****************  START CONTENT SECTION  *************   -->
            <h3>Page Not Found </h3></td>
        </tr>
        <tr>
          <td><p> The web page you have asked for cannot be found. This could be for several reasons. Perhaps you mistyped the URL, or a link to our website has been mistyped from another webpage. We apologize for the inconvenience. </p>
            <p> You have several options: </p>
            <ul>
              <li>Visit the <a href="/">National Weather Service</a> homepage; </li>
              <li>Select from the subjects on the left side of this page to find what you are looking for; </li>
              <li>Use the search option in the upper right section of this page to search. </li>
            </ul>
            <!--  *****************  END CONTENT SECTION  *************   -->
          </td>
        </tr>
...
&nbsp;&nbsp;&nbsp;&nbsp; <span class="gray">Page last Modified:</span> <!-- #BeginEditable "DateLastMod" --> <span class="gray">
      <!-- start modified date -->
      <!-- #BeginDate format:Sw1a -->8 September, 2005 9:34 AM<!-- #EndDate -->
      <!-- end modified date -->
      </span> <!-- #EndEditable --> </td>
  </tr>
</table>
