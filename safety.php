...
<title>Weather Safety - NOAA's National Weather Service</title>
<meta name="DC.title" content="Weather Safety - NOAA's National Weather Service" />
...
<!-- ========== end leftmenu inc ========== -->
    ...
    <td width="525" valign="top">
      ...
      <table width="525" border="0" cellpadding="0" cellspacing="2">
        <tr>
          <td rowspan="3">&nbsp;</td>
          <td><a name="contents" id="contents"></a><a href="/">Home</a> > Safety <br />
            <br />
          </td>
        </tr>
        <tr>
          <td><!--  *****************  START CONTENT SECTION  *************   -->
            <h3>Weather Safety </h3></td>
        </tr>
        <tr>
          <td> This page contains links to National Oceanic Atmospheric Administration web sites that contain information about weather safety.
            <ul>
              <li> <a href="/stormready/">StormReady</a></li>
              <li><a href="/nwr/">NOAA Weather Radio</a> </li>
              <li><a href="http://iwin.nws.noaa.gov/emwin/index.htm">Emergency Managers Information Network</a></li>
              <li><a href="http://www.cpc.noaa.gov/products/expert_assessment/threats.html">U.S. Hazard Assmt...</a></li>
              <li><a href="/om/heat/index.shtml">Heat</a></li>
              <li><a href="http://www.lightningsafety.noaa.gov">Lightning</a></li>
              <li><a href="/om/hurricane/index.shtml">Hurricanes</a></li>
              <li><a href="/om/severeweather/index.shtml">Thunderstorms</a></li>
              <li><a href="/om/severeweather/index.shtml">Tornadoes</a></li>
              <li><a href="http://www.ripcurrents.noaa.gov/">Rip Currents</a></li>
              <li><a href="/om/severeweather/index.shtml">Floods</a></li>
              <li><a href="/om/winter/index.shtml">Winter</a></li>
              <li><a href="/os/uv/">Ultra Violet Radiation Safety</a></li>
              <li><a
href="/cgi-bin/nwsexit.pl?url=http://redcross.org">Red Cross</a></li>
              <li><a
href="http://www.fema.gov">Federal Emergency Management Agency (FEMA)</a></li>
            </ul>
            <p>NWS Safety Campaigns</p>
            <ul>
              <li><a href="http://www.ripcurrents.noaa.gov">Rip Current Awareness</a></li>
              <li><a href="http://www.weather.gov/airquality/">Air Quality Awareness</a></li>
              <li><a href="http://www.weather.gov/floodsafety/">Flood Safety Awareness Week</a></li>
              <li><a href="http://www.nhc.noaa.gov/HAW2/english/intro.shtml">Hurricane Preparedness</a></li>
              <li><a href=" http://www.lightningsafety.noaa.gov">Lightning Awareness</a></li>
              <li><a href="http://weather.gov/om/severeweather/index.shtml">Severe Weather & FlashFlood Awareness</a></li>
              <li><a href="http://www.nws.noaa.gov/om/winter/index.shtml">Winter Weather Awareness</a></li>
              <li><a href="http://wcatwc.arh.noaa.gov">Tsunami Awareness</a></li>
              <li><a href="/os/water/tadd/
">Turn Around Don't Drown</a></li>
            </ul>
            <!--  *****************  END CONTENT SECTION  *************   -->
          </td>
        </tr>
...
&nbsp;&nbsp;&nbsp;&nbsp; <span class="gray">Page last Modified:</span> <!-- #BeginEditable "DateLastMod" --> <span class="gray">
      <!-- start modified date -->
      <!-- #BeginDate format:Sw1a -->19 March, 2007 9:14 AM<!-- #EndDate -->
      <!-- end modified date -->
      </span> <!-- #EndEditable --> </td>
  </tr>
</table>
