...
<title>Satellite Images - NOAA's National Weather Service</title>
<meta name="DC.title" content="Satellite - NOAA's National Weather Service" />
...
<meta name="DC.date.reviewed" scheme="ISO8601" content="2005-09-22" />
...
//used for changing images for weather.gov/sat_tab.php web page
if (document.images)
   {
     image1= new Image(100,100);
     image1.src="http://weather.gov/satellite_images/national.jpg";
     image2= new Image(100,100);
     image2.src="http://weather.gov/satellite_images/vis_national.jpg";
     image3= new Image(100,100);
     image3.src="http://weather.gov/satellite_images/wv_national.jpg";
   }
//used in the onmouseover call from page weather.gov/sat_tab.php
...
<!-- ========== end leftmenu inc ========== -->
    ...
    <td width="525" valign="top"><!-- Start Content area... 525px wide -->
        ...
        <tr>
          <td><table width="525" border="0" cellpadding="0" cellspacing="0" class="tabs" name="Tabs">
              <tr align="center">
                ...
                <td align="left"><img src="images/tab_right.off.jpg" alt="" width="4" height="34" /></td>
                <td align="right"><img src="images/tab_left.off.jpg" alt="" width="3" height="34" /></td>
                <td background="images/tab_middle.off.jpg">&nbsp;&nbsp;<a href="radar_tab.php">Radar</a>&nbsp;&nbsp;</td>
                <td align="left"><img src="images/tab_right.off.jpg" alt="" width="4" height="34" /></td>
                <td align="right"><img src="images/tab_left.off.jpg" alt="" width="3" height="34" /></td>
                ...
                <td background="images/tab_middle.on.jpg" class="tabs">&nbsp;Satellite&nbsp;</td>
            ...
            <table width="525" border="0" cellpadding="0" cellspacing="0" height="425" bgcolor="#003399">
              <tr>
                <td><table width="480" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="160"><div align="right" id="menuitem"> <a href="sat_tab.php?image=ir" onmouseover="change1('pic1','image1')" onfocus="this.onmouseover()" alt="Infrared Image" ><span class="yellow">Infrared</span></a> </div></td>
                      <td width="160"><div align="center" id="menuitem"> <a href="sat_tab.php?image=vis" onmouseover="change1('pic1','image2')" onfocus="this.onmouseover()" alt="Visible Image" ><span class="yellow">Visible</span></a> </div></td>
                      <td width="160"><div align="left" id="menuitem"> <a href="sat_tab.php?image=wv" onmouseover="change1('pic1','image3')" onfocus="this.onmouseover()" alt="Water Vapor Image" ><span class="yellow">Water
                              Vapor</span></a> </div></td>
                    </tr>
                  </table></td>
              </tr>
              <tr>
                <td align="center"><div align="center"><img src="http://www.weather.gov/satellite_images/national.jpg" name="pic1" width="512" height="455" alt="Satelite Image" ></div>
                   <br />
                  <table width="10%" border="0" cellpadding="0" cellspacing="0" >
                    <tr>
                      <td nowrap="nowrap">&nbsp;&nbsp; <a href="sat_loop.php?image=ir&amp;hours=24"><span class="yellow">24
                          hour Loop</span></a>&nbsp;&nbsp;&nbsp;&nbsp; <a href="sat_loop.php?image=ir&amp;hours=12"><span class="yellow">12
                          hour Loop</span></a>&nbsp;&nbsp;&nbsp;&nbsp; <a href="sat_loop.php?image=ir&amp;hours=6"><span class="yellow">6
                          hour Loop</span></a>&nbsp;&nbsp;&nbsp;&nbsp; <a href="sat_loop.php?image=ir&amp;hours=3"><span class="yellow">3
                          hour Loop</span></a>&nbsp;&nbsp; </td>
                    </tr>
                  </table>
                  <br />
      ...
      <table border="0" align="center" cellpadding="0" cellspacing="2">
        <tr>
          <td height="16" align="center" nowrap="nowrap"><a href="al_sat_tab.php">Alaska</a>&nbsp;&nbsp; |&nbsp;&nbsp;<a href="ha_sat_tab.php">Hawaii</a>&nbsp;&nbsp;|&nbsp;&nbsp; <a href="gu_sat_tab.php">Guam</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="pr_sat_tab.php">Puerto
              Rico</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="sa_sat_tab.php">American
              Samoa</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="http://www.goes.noaa.gov/g8hu.html">Hurricane
              Sectors</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="http://www.ssd.noaa.gov/PS/PCPN/pcpn-na.html">Details</a></td>
          <td align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
        </tr>
      </table>
      <!--  *****************  END CONTENT SECTION  *************   -->
...
<!-- end footer inc -->      <!-- end footer -->
      ...
      <!-- start modified date -->
      <!-- #BeginDate format:Sw1a -->28 November, 2007 2:27 PM<!-- #EndDate -->
      <!-- end modified date -->
      </span> <!-- #EndEditable --> </td>
  </tr>
</table>
